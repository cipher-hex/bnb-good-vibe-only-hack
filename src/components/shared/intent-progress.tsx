...
export default function IntentProgress({
  currentStep,
  isVisible,
  onClose,
}: IntentProgressProps) {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 bg-card rounded-2xl shadow-2xl p-6 min-w-[400px] border border-border">
      ...
      <div className="mt-4 pt-4 border-t border-border">
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="text-foreground font-medium">
            ~{Math.max(1, (7 - currentStep) * 15)} seconds
          </span>
        </div>
      </div>
    </div>
